...
The models have been trained using pitch by pitch data from 2019 found [here](https://www.kaggle.com/datasets/pschale/mlb-pitch-data-20152018?resource=download). The MSE of the K-Nearest Neighbors model is 0.6724.